  ...
  days: [
    {
      ...
      weekday: "четверг",
      shortLabel: "23 апр",
      title: "Нотр-Дам, остров Сите и тихий левый берег",
      summary:
        "Первый полный день собран мягко: без перегруза, с красивым пешеходным маршрутом и одним из самых атмосферных районов Парижа.",
    ...
    },
    {
      ...
      weekday: "пятница",
      shortLabel: "24 апр",
      title: "Dior, Avenue Montaigne и вечерний правый берег",
      summary:
        "Правый берег здесь складывается красиво и без спешки: Dior, немного модного Парижа и собранный шопинг без лишнего шума.",
    ...
    },
    {
      ...
      weekday: "суббота",
      shortLabel: "25 апр",
      title: "Ранний Монмартр и более локальный Париж",
      summary:
        "Монмартр здесь оставлен только на раннее утро, а дальше день мягко уходит в более локальный, спокойный и живой Париж.",
    ...
    },
    {
      ...
      weekday: "воскресенье",
      shortLabel: "26 апр",
      title: "Парки, набережные и медленный Париж",
      summary:
        "Воскресенье специально оставлено лёгким: вместо точечного шопинга здесь воздух города, мосты, сады и длинная прогулка без спешки.",
    ...
    },
    {
      ...
      weekday: "понедельник",
      shortLabel: "27 апр",
      title: "Маре, Alaïa, Merci и вечерняя Сена",
      summary:
        "Один из самых цельных дней поездки: мода, предметы, книжные и вечерняя Сена, если погода даст красивый свет.",
    ...
    },
    {
      ...
      weekday: "вторник",
      shortLabel: "28 апр",
      title: "Левый берег, красивые покупки и подарки",
      summary:
        "Тот самый день, где покупки не утомляют: хороший завтрак, красивый левый берег и несколько точных адресов вместо бесконечного шопинга.",
    ...
    },
    {
      ...
      weekday: "среда",
      shortLabel: "29 апр",
      title: "Лувр в вечернем свете",
      summary:
        "Самый важный музейный день поездки: Лувр поставлен туда, где он логичнее всего и по официальному графику, и по ощущению вечернего города.",
    ...
    },
    {
      ...
      weekday: "четверг",
      shortLabel: "30 апр",
      title: "Версаль как отдельный день",
      summary:
        "Версаль оставлен отдельным днём, чтобы прожить его спокойно: дворец, сады, Trianon и мягкое возвращение в город без гонки.",
    ...
    },
    {
      ...
      weekday: "пятница",
      shortLabel: "1 мая",
      title: "День вылета: спокойное утро и мягкий финал",
      summary:
        "Финальное утро лучше собрать максимально спокойно: без лишних поисков открытого кафе на День труда и без сложной логистики перед дорогой домой.",
